...
if (isset($_POST["insert"])) {
    ...
    $file = null; // Set a default value or handle the situation accordingly
}
...
if (isset($_FILES["image2"]["tmp_name"]) && !empty($_FILES["image2"]["tmp_name"])) {
    ...
    // Handle the case where no file has been uploaded
    // For example, you can display an error message or set a default value
    $file2 = null; // Set a default value or handle the situation accordingly
}
    ...
    if (mysqli_query($con, $query)) {
        ...
        echo "<script>if(confirm('Couldn't insert values! Please Try again!')){document.location.href='insertevidences.php'};</script>";
    }
}

// Fetch officer details
$officer_query = "CALL `viewOfficer`()";
...
// Fetch lab details
$lab_query = "CALL `viewLab`()";
$run_lab = mysqli_query($con, $lab_query);
